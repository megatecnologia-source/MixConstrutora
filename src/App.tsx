            ...
            <form className="space-y-5 md:space-y-8">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8">
                <div className="space-y-2 md:space-y-3">
                  ...
                  <input type="text" className="w-full bg-bg-main rounded-xl md:rounded-2xl px-4 md:px-6 py-3 md:py-4 text-teal-deep focus:ring-2 focus:ring-brand-medium outline-none transition-all font-medium touch-target" placeholder="Seu nome" />
                </div>
                <div className="space-y-2 md:space-y-3">
                  <label className="text-[10px] md:text-xs uppercase tracking-widest font-bold text-teal-deep/40">Empresa / Órgão</label>
                  <input type="text" className="w-full bg-bg-main rounded-xl md:rounded-2xl px-4 md:px-6 py-3 md:py-4 text-teal-deep focus:ring-2 focus:ring-brand-medium outline-none transition-all font-medium touch-target" placeholder="Nome da instituição" />
                </div>
              </div>
              <div className="space-y-2 md:space-y-3">
                <label className="text-[10px] md:text-xs uppercase tracking-widest font-bold text-teal-deep/40">Tipo de Serviço</label>
                <select className="w-full bg-bg-main rounded-xl md:rounded-2xl px-4 md:px-6 py-3 md:py-4 text-teal-deep focus:ring-2 focus:ring-brand-medium outline-none transition-all font-medium appearance-none touch-target">
              ...
              <div className="space-y-2 md:space-y-3">
                ...
                <textarea rows={3} md:rows={4} className="w-full bg-bg-main rounded-xl md:rounded-2xl px-4 md:px-6 py-3 md:py-4 text-teal-deep focus:ring-2 focus:ring-brand-medium outline-none transition-all font-medium resize-none touch-target" placeholder="Conte-nos sobre sua necessidade"></textarea>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8">
                <div className="space-y-2 md:space-y-3">
                  <label className="text-[10px] md:text-xs uppercase tracking-widest font-bold text-teal-deep/40">Telefone</label>
                  <input type="tel" className="w-full bg-bg-main rounded-xl md:rounded-2xl px-4 md:px-6 py-3 md:py-4 text-teal-deep focus:ring-2 focus:ring-brand-medium outline-none transition-all font-medium touch-target" placeholder="(00) 00000-0000" />
                </div>
                <div className="space-y-2 md:space-y-3">
                  <label className="text-[10px] md:text-xs uppercase tracking-widest font-bold text-teal-deep/40">E-mail</label>
                  <input type="email" className="w-full bg-bg-main rounded-xl md:rounded-2xl px-4 md:px-6 py-3 md:py-4 text-teal-deep focus:ring-2 focus:ring-brand-medium outline-none transition-all font-medium touch-target" placeholder="seu@email.com" />
                </div>
              </div>
              <div className="pt-4 md:pt-6">
                <button className="btn-primary w-full flex items-center justify-center gap-2 md:gap-3 text-sm md:text-lg">
                  Enviar Solicitação
